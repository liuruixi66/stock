...
const columnTypes = {
  ...
  'speed_increase': 'rate',
  'speed_increase_5': 'rate',
  'speed_increase_60': 'rate',
  'speed_increase_all': 'rate'
}

// 定义格式化函数
const formatters = {
  'volume': (value: number) => (value / 100).toFixed(2) + '手',
  'deal_amount': (value: number) => (value / 10000).toFixed(2) + '万',
  'volume_ratio': (value: number) => value.toFixed(2)
}

...
class stock_fund_em:
    ...
    def stock_individual_fund_flow_rank(self,indicator: str = "5日") -> pd.DataFrame:
        """
        东方财富网-数据中心-资金流向-排名
        https://data.eastmoney.com/zjlx/detail.html
    ...
    @lru_cache()
    def _get_stock_sector_fund_flow_summary_code(self) -> dict:
        """
    ...
    def stock_sector_fund_flow_summary(self,
        ...
        :rtype: pandas.DataFrame
        """
        code_name_map = self._get_stock_sector_fund_flow_summary_code()
    ...
    def stock_sector_fund_flow_hist(self,symbol: str = "电源设备") -> pd.DataFrame:
        """
    ...
    @lru_cache()
    def _get_stock_concept_fund_flow_summary_code(self) -> dict:
        """
    ...
    def stock_concept_fund_flow_hist(self,symbol: str = "锂电池") -> pd.DataFrame:
        """
        ...
        :rtype: pandas.DataFrame
        """
        code_name_map = self._get_stock_concept_fund_flow_summary_code()
        url = "https://push2his.eastmoney.com/api/qt/stock/fflow/daykline/get"
        params = {
            "lmt": "0",
            "klt": "101",
...
if __name__ == "__main__":
    models=stock_fund_em()
    stock_individual_fund_flow_df = models.stock_individual_fund_flow(
        stock="600094", market="sh"
    )
    print(stock_individual_fund_flow_df)

    stock_individual_fund_flow_rank_df = models.stock_individual_fund_flow_rank(indicator="今日")
    print(stock_individual_fund_flow_rank_df)

    stock_individual_fund_flow_rank_df = models.stock_individual_fund_flow_rank(indicator="3日")
    print(stock_individual_fund_flow_rank_df)

    stock_individual_fund_flow_rank_df = models.stock_individual_fund_flow_rank(indicator="5日")
    print(stock_individual_fund_flow_rank_df)

    stock_individual_fund_flow_rank_df = models.stock_individual_fund_flow_rank(
        indicator="10日"
    )
    print(stock_individual_fund_flow_rank_df)

    stock_market_fund_flow_df = models.stock_market_fund_flow()
    print(stock_market_fund_flow_df)

    stock_sector_fund_flow_rank_df = models.stock_sector_fund_flow_rank(
    ...
    stock_sector_fund_flow_summary_df = models.stock_sector_fund_flow_summary(symbol="电源设备", indicator="今日")
    print(stock_sector_fund_flow_summary_df.dtypes)

    stock_sector_fund_flow_hist_df = models.stock_sector_fund_flow_hist(symbol="电源设备")
    print(stock_sector_fund_flow_hist_df)

    stock_concept_fund_flow_hist_df = models.stock_concept_fund_flow_hist(symbol="锂电池")

...
# 检测操作系统，如果是Linux则使用Linux版本
if platform.system() == 'Linux':
    print("检测到Linux系统，加载Linux兼容版本...")
    try:
        from .xtdata_linux import *
        print("Linux版本xtdata模块加载成功")
    except ImportError as e:
        print(f"Linux版本加载失败: {e}")
        # 如果Linux版本加载失败，继续使用原版本（可能会报错）
        pass
else:
    # Windows系统，使用原始导入
